...
Your [organization](organization.mdx) creates customers and [integrations](integrations.mdx) in Prismatic.
...
Like all Prismatic resources, customers can be managed via Prismatic's CLI tool, [prism](cli/cli-usage.mdx), or through the web app by clicking the **Customers** link on the left-hand sidebar.

<Screenshot
  filename="customers/customers-page.png"
  alt="List of customers in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Add customer in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Search customer in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Edit customer details in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="800px"
  alt="Search customers by label in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Deploy instance to a customer in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Alert monitors list for customer in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="800px"
  alt="Add alert monitor in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Alert monitors for an instance in Prismatic app"
/>
...
At Prismatic we believe verbose and searchable logs are critical to any software ecosystem.
...
<Screenshot
  ...
  alt="Access customer instance logs in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Search customer instance logs in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Filter customer instance logs in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Customer instance log entry details in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Logs and step outputs for customer instances in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="800px"
  alt="Manage customer users in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Add attachments to customers in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="400px"
  alt="Delete customer in Prismatic app"
/>
...
So, if you know "Smith Rocket Company" as a customer with an ID of `abc-123` in another system you use, you can assign "Smith Rocket Company" in Prismatic the `externalId` of `abc-123`.
...
<Screenshot
  ...
  maxWidth="700px"
  alt="Set customer external IDs in Prismatic app"
/>
...
In addition at a **name** and **description**, a customer created through the [createCustomer](api/schema/mutation/createCustomer.mdx) mutation can be assigned an `externalId`, so that you can match customers in Prismatic to customers saved in other systems.

See our [Syncing Customers to Prismatic](quickstarts/syncing-customers-to-prismatic.mdx) quickstart guide for an example of how to sync customers to Prismatic using our API.
