...
Prismatic's **integration marketplace** is a place where you can present your integrations to your customers.
You can [embed](embedding-marketplace.mdx) marketplace within your app so your users can seamlessly deploy integrations natively using your existing authentication system.
...
So, when customers log in to Prismatic they're presented phrases like "activate this integration", or "configure this integration".
...
2. For a fully native expeirence, you can use the [embedded SDK](installing-embedded.mdx) to [query Prismatic's API](embedded-api-requests.mdx) for information on integrations.
...
3. You can create Prismatic accounts for your customers and have them log in to Prismatic to activate integrations.
   ...
   <Screenshot
     ...
     maxWidth="600px"
     caption="Your customers log in to Prismatic to activate integrations"
   />
...
1. Select the version of your integration that you would like to appear in the integration marketplace and provide a nice overview for your integration to explain to users what your integration does.
   ...
   <Screenshot
     ...
     maxWidth="600px"
     alt="Configure integration for marketplace in Prismatic app"
   />
   ...
   <Screenshot
     ...
     maxWidth="700px"
     alt="Toggle customer deployable option for integration in Prismatic app"
   />
...
<Screenshot
  ...
  maxWidth="650px"
  alt="Enable config variables for customers in Prismatic app"
/>
...
:::info You can embed marketplace, or let your customers log in to Prismatic
...
You have the option to create [customer users](users.mdx#customer-users) in Prismatic, allowing your customers to log in to Prismatic and activate integrations for themselves.
:::

Once you have an integration in your marketplace, customers can activate the integration to themselves.
The customer's view of Prismatic differs from an organization user's view - a customer can only see integrations, configuration, users, etc., that are specific to them.
...
<Screenshot
  ...
  maxWidth="700px"
  alt="List of integrations with activated integrations highlighted in Prismatic integration marketplace"
/>
...
<Screenshot
  ...
  maxWidth="700px"
  alt="Customer activates integration in Prismatic integration marketplace"
/>
...
<Screenshot
  ...
  maxWidth="700px"
  alt="Customer configures integration in Prismatic integration marketplace"
/>
