---
id: changelog
title: Prismatic Changelog
description: The latest updates to the Prismatic platform make it even easier to build, manage, and deploy integrations for your customers.
---

<ChangeLogEntry date="2024-08-05">
...
- [Klaviyo](components/klaviyo.mdx) - Klaviyo is a cloud based email marketing solution that enables e-commerce businesses to create, send, and analyze email and SMS campaigns.
- [Bill](components/bill.mdx) - Bill is a leading provider of cloud-based software that simplifies and automates back-office financial operations for small and midsize businesses.

</ChangeLogEntry>

<ChangeLogEntry date="2024-07-31">

### Write-Only Connection Inputs

In some situations, it can be helpful to make a connection input **write-only** (e.g. a user can enter an API key, password, etc, but cannot retrieve it later).
You can now mark any connection input as **write-only**.

Read more about write-only connection inputs in our [docs](configuration-wizard.mdx#write-only-connection-inputs).

</ChangeLogEntry>

<ChangeLogEntry date="2024-07-17">

### Reference Existing Actions in Code-Native

You can now reference existing components' actions in a code-native integration's flow.
This allows you to leverage Prismatic's existing [component library](components/component-catalog.mdx) while working in your favorite IDE with TypeScript and other tools you love.

<Vimeo video="985886719" />

Read more about invoking actions in code-native in our [docs](code-native-integrations.mdx#using-existing-actions-in-code-native).
...
- [Karbon](components/karbon.mdx) - Karbon is a collaborative practice management platform for accounting firms.
- [Workday (Beta)](components/workday.mdx) - Workday HCM is a single, cloud-based solution for workforce planning, talent management, and payroll processes.
- [Duro PLM](components/duro-plm.mdx) - Duro PLM is a platform designed to intuitively centralize part data, manage change orders, and connect to the rest of your tech stack.
...
When you create a new integration, you can now start from a variety of Prismatic-built integration templates.
...
You can now use Prismatic-provided GitHub Actions to automate the deployment of your components and integrations to Prismatic.
This is handy if you have multiple Prismatic tenants and you've designated one for development and the other(s) for production.

<Vimeo video="962688223" />

Read more about how to use the [Prismatic GitHub Actions](github-actions.mdx) in our docs.
...
- [Sage 200](components/sage-200.mdx) - Sage 200 is an online business management solution designed to help businesses manage their finances, customers, and business insight in one solution.
- [Bynder](components/bynder.mdx) - Bynder is a leading digital asset management software that allows users to easily create, find, and use content, such as documents, graphics, and videos.
...
You can now search Prismatic's docs from within the web app.
...
Read more about how the on-prem agent works in [docs](on-prem-agent.mdx).
...
- [Microsoft Intune](components/ms-intune.mdx) - Microsoft Intune is a cloud-based service that focuses on device management and application management. Use the Microsoft Intune component to manage users, devices, and applications.
- [ServiceDesk Plus](components/servicedesk-plus.mdx) - ServiceDesk Plus is a comprehensive service desk software that offers a suite of IT Service management, IT asset management, CBDM, and more. Use the ServiceDesk Plus to efficiently manage Assets and Configuration Items for integrations.
- [Databricks](components/databricks.mdx) - Databricks is an analytics and artificial intelligence platform where you can build, scale and govern data and AI, including generative AI and other machine learning models. Manage compute, workflow jobs, ML models, SQL queries and more within a Databricks workspace.
- [Zendesk Knowledge](components/zendesk.mdx) - Zendesk Knowledge is a comprehensive solution that allows you to manage content such as articles, sections, categories, topics, and posts, as well as subscriptions and attachments in the Help Center of Zendesk. The Knowledge and Help Center actions have been added to our existing Zendesk Component.
...
- [Contentful](components/contentful.mdx) - Contentful is a content management system (CMS) that allows developers to manage and deliver content across multiple platforms and devices.
...
Check out the [code-native documentation](code-native-integrations.mdx) and the video below to learn more.
...
- [ServiceTitan](components/servicetitan.mdx) - ServiceTitan is a comprehensive field service management solution that helps businesses manage their operations, workforce, and customer service.
- [Yoti Sign](components/yoti-sign.mdx) - Yoti Sign is a digital identity and e-signature solution that allows users to verify their identity and sign documents electronically and securely.
...
Check out [this blog post](https://prismatic.io/blog/introducing-code-native-integrations/) as well as the video below for more information about the benefits of code-native integrations. Our [code-native documentation](code-native-integrations.mdx) is an excellent place to start when you're ready to start building your first code-native integration.
...
- [ArcGIS](components/arcgis.mdx) - Esri ArcGIS is an online geographic information system providing and maintaining detailed information and tools for maps and locations.
- [Aspose](components/aspose.mdx) - Aspose is a robust file manipulation service that can manage various document and image file formats. Use the Aspose component to create, edit, process, and convert file formats from several languages, and several platforms.
...
Update to the latest version of `@prismatic-io/embedded` and check out our [docs](embedding-marketplace.mdx#dynamic-phrases) to take advantage of this new feature.
...
- [Adobe Acrobat Sign](components/adobe-acrobat-sign.mdx) - Adobe Acrobat Sign is an e-signature management solution. Use the Adobe Acrobat Sign component to send, sign, track, and manage the signature process.
- [DocuSign](components/docusign.mdx) - DocuSign provides intuitive solutions for sending and collecting signatures on documents. Use the DocuSign component to manage signature collection and document distribution.
...
- [Sage Intacct](components/sage-intacct.mdx) - Industry-leading financial accounting software system with a broad set of functionalities for businesses across a number of different verticals. Use the Sage Intacct component to manage Invoices, Payments, Vendors, and more.
...
An integration's labels and category are now included in its YAML definition when it is [exported as a YAML file](integrations.mdx#yaml-definition).
...
- [Expensify](components/expensify.mdx) - Programmatically download expense report data for analysis or insertion into your accounting package, provision accounts for new hires, and much more.
- [Calendly](components/calendly.mdx) - Manage the scheduling of events; attendee availability; and retrieve pertinent data on users and attendees.
- [Confluence](components/confluence.mdx) - Manage spaces, pages, and content properties on your Confluence workspaces.
- [Qlik](components/qlik.mdx) - Manage your Data Sets, Assets, and Apps.
...
[Connection templates](connections.mdx#connection-templates) allow you to prepopulate input values for common connections used by you and your customers.
...
- [Paylocity](components/paylocity.mdx) - Performs tasks related to workforce management, payroll, and other HR tasks
...
- [Azure OpenAI Service](components/azure-openai-service.mdx) - Performs OpenAI functions using Microsoft Azure's OpenAI service models.
- [Adobe I/O Events](components/adobe-io-events.mdx) - Facilitates trigger changes to content and data on Adobe's Experience Platform; or when predefined rules or thresholds have been met.
- [ShipStation](components/shipstation.mdx) - This component allows you to list, create, update, and delete orders and shipments in your ShipStation account.
- [Segment](components/segment.mdx) - Manage your Sources, Warehouses, and Destinations of your Segment account.
- [Amazon Seller Central](components/amazon-seller-central.mdx) - Manage your catalog, orders, and shipping information of the managed stores on your amazon seller account.
...
Read more about these new events in our [docs](custom-components/writing-custom-components.mdx#instance-deploy-and-delete-events-for-triggers).
...
For more information, see [docs](logging.mdx/#disabling-logs-and-step-results).
...
Prismatic currently supports any font available in the [Google Fonts](https://fonts.google.com/) catalog.

Read more about [custom fonts](embedding-marketplace.mdx#using-a-custom-font) in our docs.
...
1. You can now issue a `prismatic.showDashboard()` to give users a holistic view of their integrations, instances, executions, logs, and more. See [docs](embedded-designer.mdx#showing-the-customer-dashboard) for more information.
   <Screenshot
...
Embedded designer allows your customers to log in to your app and build integrations using Prismatic's integration designer.
...
See [docs](instances.mdx/#instance-execution-retry-and-replay) for more information, and the [Examples repo](https://github.com/prismatic-io/examples/tree/main/api/replay-failed-executions) in GitHub for the script mentioned in the above video.
...
`prism` wraps the [Prismatic API](api/api-overview.mdx) and provides users a way to perform CRUD (create, read, update, delete) operations on a variety of Prismatic resources (components, integrations, instances, customers, etc.) from the command line.
...
You've probably noticed that the Prismatic UI has gotten a facelift!
...
- [Prismatic](components/prismatic.mdx) - Interact with the Prismatic API to manage customers, integrations, instances, etc.
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Clone integration flow in Prismatic app"
/>
...
To get started with filtering your embedded marketplace, update your [@prismatic-io/marketplace](https://www.npmjs.com/package/@prismatic-io/marketplace) package to version 1.1.2, and add a `filters` attribute to your `prismatic.showMarketplace()` invocation - see [docs](embedding-marketplace.mdx#filtering-integrations) for details.
...
You can now assign labels to your [customers](customers.mdx#customer-labels), [integrations](integrations.mdx#integration-labels) and [instances](org-deployed-instances.mdx).
This helps you keep your Prismatic account organized so you can find what you need quickly.

<Screenshot
  filename="changelog/labels.png"
  maxWidth="650px"
  alt="Assign labels to customers, integrations and instances in Prismatic app"
/>
...
It's now easier to integrate with SOAP-based APIs. For quick one-off calls, you can use our built-in [SOAP component](components/soap.mdx) to fetch WSDL definitions and make requests to an API's SOAP methods. For more complex SOAP APIs, you can leverage our custom component SDK to wrap SOAP methods into a series of component actions.
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Expressions for step inputs in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="500px"
  alt="Configure webhook trigger in Prismatic app"
/>
...
You can now invite third-party vendors to log in to Prismatic with limited access to your integrations, custom components, and customers.
...
So, if you're integrating with two competing companies, or even with one of your competitors, they are not given insight into the other integrations, custom components, or customers you have in your Prismatic account.
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Assign integration to category in Prismatic app"
/>

<Screenshot
  filename="changelog/filter-by-category.png"
  maxWidth="600px"
  alt="Filter integrations by category in Prismatic app"
/>
...
1. The **Selected Test Run** dropdown has been moved to the input reference selector.
   ...
   <Screenshot
     ...
     maxWidth="400px"
     alt="Select test run in Prismatic app"
   />
2. Prismatic's CLI, Prism, has been updated to version 3.0.0 to account for this change.
...
Check out our [building integrations](building-integrations.mdx#flows-in-integrations) page for more information.
...
Prismatic's custom component TypeScript library, `@prismatic-io/spectral`, has been expanded and updated to improve the developer experience for [building custom components](custom-components/writing-custom-components.mdx).
...
You can dive in to the Spectral code on [GitHub](https://github.com/prismatic-io/spectral).
...
Organizations with an enterprise plan can now create a custom theme for the Prismatic web application.
This takes Prismatic’s white-label capabilities to the next level by allowing you to customize the color scheme and other UI elements to match your branding.
...
<Screenshot
  ...
  maxWidth="700px"
  alt="Configure instances to run on customer schedule via Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Integration configuration and config variables via Prismatic app"
/>
...
Prismatic handles several common state persistence scenarios for you through the new [Persist Data](components/persist-data.mdx) and [Process Data](components/process-data.mdx) components.
