...
description: Examine all the features of the low-code integration designer
---

import Icon from "@mui/material/Icon";

When you build an integration, you can build it in the low-code designer, or as a TypeScript project in your favorite IDE using the [Code-Native SDK](code-native-integrations.mdx).
This article covers how to build an integration with the low-code designer.

After [creating a new integration](integrations.mdx#creating-a-new-integration) or selecting one from your list of integrations, you will find yourself in the low-code **integration designer**.
...
<Screenshot
  ...
  alt="Prismatic integration designer highlighting configuration drawer, testing drawer, version history drawer, and integration editor pane"
/>
...
<Screenshot
  ...
  maxWidth="400px"
  alt="Choose component or action to add step in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Clone a step in Prismatic app"
  maxWidth="420px"
/>
...
<Screenshot
  ...
  alt="Change a step's action in Prismatic app"
  maxWidth="420px"
/>
...
<Screenshot
  ...
  alt="Example of step outputs as a list in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Example of step outputs as a file in Prismatic app"
/>
...
If you need to enter multiple lines of text for an input value, you can use the [Join Lines](components/text-manipulation.mdx#join-lines) action to concatenate multiple lines of text into a single string.
...
<Screenshot
  ...
  maxWidth="550px"
  alt="Set input value in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="550px"
  alt="Reference earlier step result as step input in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="500px"
  alt="Config variable inputs in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="550px"
  alt="Add template input in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Template inputs in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Rename a step in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="450px"
  alt="Reorder flow steps in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="400px"
  alt="Component version list highlighting latest version in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="400px"
  alt="Manage integration flows in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="500px"
  alt="Set integration to retry in Prismatic app"
/>

**Retry Attempts** indicates the maximum number of times (up to 10) that Prismatic will run the same instance invocation in the event of failure.
...
**Minutes Between Attempts** indicates the number of minutes that Prismatic should wait before trying to run an instance again.
...
Prismatic provides the [loop component](components/loop.mdx) to allow you to loop over an array of items, or you can loop a predetermined number of times.
...
<Screenshot
  ...
  maxWidth="800px"
  alt="Loop over files by referencing results of list files step in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="800px"
  alt="Loop over items to get file paths in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="750px"
  alt="Loop over paginated API in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Branch on value in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Branch on expression in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="550px"
  alt="Branch on expression using conditionals in Prismatic app"
/>
...
Prismatic provides the [Select Executed Step Result](components/branch.mdx#select-executed-step-result) to handle that scenario.
...
<Screenshot
  ...
  alt="Select executed step result while branching in Prismatic app"
/>
...
Prismatic provides components that allow you to save some state from one run for use in a future run.
