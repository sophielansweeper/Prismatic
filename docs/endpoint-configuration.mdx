...
<Screenshot
  ...
  maxWidth="550px"
  alt="Select endpoint type in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="550px"
  alt="Set flow name from HTTP payload for Endpoint Configuration in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="550px"
  alt="Set flow name from HTTP header for Endpoint Configuration in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="550px"
  alt="Set flow name from preprocess flow for Endpoint Configuration in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="550px"
  alt="Set flow name from HTTP payload or header for shared endpoint configuration in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="550px"
  alt="Set flow name with preprocess flow for shared endpoint configuration in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Test endpoint configuration in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="350px"
  alt="Endpoint configuration security options in Prismatic app"
/>
...
- `unsecured` - do not use API keys.
  Secure webhooks some other way (like with [HMAC](best-practices/secure-webhook-endpoints-hmac.mdx)).
...
- `customer_required` - customers are requred to supply API keys.
- `organization` - you specify the API keys that will be used.
  If you specify `"organization"`, also provide a string array of API keys for the `organizationApiKeys` property.

```ts title="Secure a flow with API keys" {6,7}
...
<Screenshot
  ...
  maxWidth="700px"
  alt="Endpoint configuration in config wizard in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="700px"
  alt="Add trigger details to config wizard in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="700px"
  alt="Trigger details in config wizard in Prismatic app"
/>
