...
The Prismatic integration runner is allocated 1GB of RAM for execution.
...
Prismatic writes response to a file in Amazon S3, and responds with an HTTP 303 (Redirect) to the object in S3.
