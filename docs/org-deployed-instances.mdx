...
Generally, it's best to give your customers the ability to deploy instances themselves through the [integration marketplace](integration-marketplace.mdx).
...
<Screenshot
  ...
  maxWidth="450px"
  alt="Create instance in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="800px"
  alt="Set instance version in Prismatic app"
/>
