...
<Screenshot
  ...
  maxWidth="750px"
  alt="Pause instance in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="700px"
  alt="Test instance in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Instance execution details in Prismatic app"
/>
...
For an example of how to bulk-replay failed executions, see our [examples repo](https://github.com/prismatic-io/examples/tree/main/api/replay-failed-executions) in GitHub or review the [Execution Retry & Replay](retry-and-replay.mdx) docs.
...
<Screenshot
  ...
  maxWidth="450px"
  alt="Delete instance in Prismatic app"
/>
