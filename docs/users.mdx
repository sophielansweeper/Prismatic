...
<Screenshot
  ...
  alt="List of org users in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="500px"
  alt="Add team member in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Edit team member in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="450px"
  alt="Add third-party team member in Prismatic app"
/>
...
<Screenshot
  ...
  alt="Set granular access for third-party team member in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="450px"
  alt="Add specific permissions to third-party team member in Prismatic app"
/>
...
That way, they can test invoking an integration in Prismatic from their third-party service and can verify that the data the integration receives is in the format you agreed upon.
...
<Screenshot
  ...
  maxWidth="450px"
  alt="Select integration for third-party permissions in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="450px"
  alt="Choose integration permissions for third-party team member in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="800px"
  alt="Single integration in Prismatic app"
/>
...
By default, third-party users have access to Prismatic built-in public components, but you may not want third-party vendors to see all of the custom components you've published (especially if you integrate with several competing vendors).
...
<Screenshot
  ...
  maxWidth="450px"
  alt="Select component for third-party permissions in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="450px"
  alt="Choose component permissions for third-party team member in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="450px"
  alt="Select customer for third-party permissions in Prismatic app"
/>
...
- A customer that is created through an [Embedded Marketplace](embedding-marketplace.mdx) is automatically assigned the **marketplace admin** role, and is permitted to deploy and manage integrations that are deployed to them.
  ...
  Note: **marketplace** users are not assigned credentials and cannot log in to Prismatic, except through the embedded integration marketplace.
...
<Screenshot
  ...
  maxWidth="800px"
  alt="Filter customer users in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="450px"
  alt="Add customer user in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Edit customer user in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="450px"
  alt="Delete customer user in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="800px"
  alt="Search all customer users in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Change own password in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="600px"
  alt="Set light/dark mode in Prismatic app"
/>
...
Similar to [syncing customers programmatically](customers.mdx#sync-customers-from-an-external-system-programmatically), if you manage customer users in an external system you can sync those users to Prismatic programmatically.
Though this tutorial is about syncing customers to Prismatic, the concepts are similar for syncing users: [Syncing Customers to Prismatic](quickstarts/syncing-customers-to-prismatic.mdx).
...
You can also specify an `externalId` if you would like users in Prismatic to easily correspond to users in an external system.
