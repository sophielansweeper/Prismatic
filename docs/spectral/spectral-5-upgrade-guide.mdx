...
The big change in Spectral 5.x is the introduction of `connections`, which allow you to package up all the information you need (endpoints, credentials, etc) into single inputs.
