...
In order to disambiguate who Prismatic's customers are, and who your customers are, we refer to Prismatic's customers as **organizations** and your customers as **customers**.
...
To create an organization within Prismatic, first <InternalLink href="/sign-up/">sign up</InternalLink>.
...
Registering with Prismatic again will create a second organization.
:::
...
You can also view your organization's utilization of Prismatic resources.
...
<Screenshot
  ...
  alt="Change logo for org in Prismatic app"
/>
...
If your team members sign in to other applications through Active Directory, Active Directory Federation Services (ADFS), or Lightweight Directory Access Protocol (LDAP), then we can configure your organization to sign in to Prismatic the same way.
...
If you are interested in using Single Sign-On for Prismatic, please reach out to our [support](mailto:support@prismatic.io) team to get SSO configured and enabled for your organization.
...
<Screenshot
  ...
  alt="Create alert groups in Prismatic app"
/>
...
<Screenshot
  ...
  maxWidth="500px"
  alt="Add alert webhook in Prismatic app"
/>
...
You can track metrics about your organization's usage of Prismatic services from the **Utilization** tab of the **Settings** page.
...
<Screenshot
  ...
  alt="Track organization usage of services in Prismatic app"
/>

## Managing billing

When you first sign up for Prismatic, you are entered into the "free plan" so you can try assembling and deploying a few integrations before paying for it.
...
<Screenshot
  ...
  alt="Manage organization billing in Prismatic app"
/>
...
As an organization with an <InternalLink href="/pricing/">Enterprise plan</InternalLink>, you can choose to interact with the Prismatic platform through a custom domain that you control.
For example, you might want to white-label Prismatic so your team members and customers access **https<!---->://integrations.your-company.com** instead of [https://app.prismatic.io](https://app.prismatic.io/).
...
Note that once a subdomain is configured, you can access your tenant through either the custom domain or the default Prismatic domain.
